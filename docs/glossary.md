...
| **Challenge runtime cache** | `evaluation_plan_json` JSONB column on the challenges table. It is the canonical execution plan used during scoring and verification. |
