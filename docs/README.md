...
- **Working on the frontend?** Read [Design System](../.claude/skills/agora-design-system/SKILL.md).
...
| Visual identity, CSS tokens, fonts | [.claude/skills/agora-design-system/SKILL.md](../.claude/skills/agora-design-system/SKILL.md) |
...
- **[.claude/skills/agora-design-system/SKILL.md](../.claude/skills/agora-design-system/SKILL.md)** — Agora visual identity and CSS tokens
