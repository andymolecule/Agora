import {
  AUTHORING_SOURCE_MAX_EXTERNAL_ID_LENGTH,
  AUTHORING_SOURCE_MAX_TITLE_LENGTH,
...
const BEACH_MAX_THREAD_ID_LENGTH = AUTHORING_SOURCE_MAX_EXTERNAL_ID_LENGTH;
const BEACH_MAX_THREAD_TITLE_LENGTH = AUTHORING_SOURCE_MAX_TITLE_LENGTH;
