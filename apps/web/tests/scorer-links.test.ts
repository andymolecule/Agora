...
test("getScorerPackageUrl links official Agora scorer images to the package page", () => {
  assert.equal(
    getScorerPackageUrl(
      "ghcr.io/andymolecule/repro-scorer@sha256:b4b94ab1b0d35fc3098a36de542805f3c74e512bb2f0cfc01f60125790f71cde",
    ),
    "https://github.com/andymolecule/Agora/pkgs/container/repro-scorer",
  );
});
