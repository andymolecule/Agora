...
test("getScorerPackageUrl links official Agora scorer images to the package page", () => {
  ...
  assert.equal(
    getScorerPackageUrl(
      "ghcr.io/andymolecule/gems-generated-scorer@sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
    ),
    "https://github.com/andymolecule/Agora/pkgs/container/gems-generated-scorer",
  );
});
